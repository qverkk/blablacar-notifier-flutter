            ...
            children: [
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: "Email"),
                          onChanged: (val) => authBloc.add(ChangeField(val,
                              "email")), //every time an input changes, call an event and change the state
                        ),
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: "Password"),
                          onChanged: (val) => authBloc.add(ChangeField(val,
                              "password")), //every time an input changes, call an event and change the state
                        ),
              ...
              Row(
                  ...
                  children: [
                    ...
                    TextButton(
                        onPressed: () => authBloc.add(InitRegistrationFlow()),
                        child: const Text(
                          "Sign up.",
                        ))
                  ])
